...
#print('Error of Softmax regression on digit (mod 3) classifications.', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
print('softmax classification error using pca representation',test_error)
